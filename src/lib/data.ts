...
const products: Omit<Product, 'price' | 'stock'>[] = [
  {
    ...
    weight: 8,
    sizeWeights: { 'S': 7.2, 'M': 8, 'L': 8.8, 'XL': 9.5, 'XXL': 10.2, 'XXXL': 11 },
    category: 'tops',
    style: 'tops',
  ...
  },
  {
    ...
    weight: 7,
    sizeWeights: { 'S': 6, 'M': 7, 'L': 8, 'XL': 9, 'XXL': 10 },
    category: 'tops',
    style: 'tops',
  ...
  },
  {
    ...
    weight: 10,
    sizeWeights: { 'S': 9, 'M': 10, 'L': 11, 'XL': 12, 'XXL': 13 },
    category: 'tops',
    style: 'shirts',
  ...
  },
  {
    ...
    weight: 28,
    sizeWeights: { 'S': 24, 'M': 26, 'L': 28, 'XL': 30, 'XXL': 32 },
    category: 'outerwear',
    style: 'hoodies',
  ...
  },
  {
    ...
    weight: 45,
    sizeWeights: { 'S': 40, 'M': 45, 'L': 50, 'XL': 55, 'XXL': 60 },
    category: 'outerwear',
    style: 'jackets',
  ...
  },
  {
    ...
    weight: 18,
    sizeWeights: { 'S': 16, 'M': 18, 'L': 20, 'XL': 22, 'XXL': 24 },
    category: 'bottoms',
    style: 'pants',
    colors: [], sizes: [], images: []
  },
  {
    ...
    weight: 26,
    sizeWeights: { 'S': 22, 'M': 24, 'L': 26, 'XL': 28, 'XXL': 30 },
    category: 'outerwear',
    style: 'hoodies',
    colors: [], sizes: [], images: []
  },
  ...
  },
  {
    ...
    weight: 48,
    sizeWeights: { 'S': 42, 'M': 45, 'L': 48, 'XL': 52, 'XXL': 56 },
    category: 'bundles',
    style: 'sets',
    colors: [], sizes: [], images: []
  },
